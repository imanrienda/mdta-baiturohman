...
class TeachersController extends Controller
{
    ...
    /**
     * Form edit profil guru (dipanggil dari route /teacher/edit-profile)
     * Nama method disesuaikan dengan route di web.php:
    ...
    public function updateTeacher(Request $request, Teacher $teacher)
    {
        ...
        return redirect('/teacher/profile')->with('status', 'Data profil berhasil diubah');
    }
    ...
    public function schedulesTeacher(Request $request)
    {
        ...
        $schedules = \App\Schedule::with(['classLearn.classRoom', 'classLearn.subject', 'semester'])
    ...
    public function indexGradeTeacher(Request $request)
    {
        ...
        $grades        = \App\Grade::where('class_room_id', $request->kelas)
                            ->where('semester_id', $request->semester)
                            ->where('teacher_id', auth()->user()->teacher->id)
                            ->get();
    ...
    public function createGradeTeacher($class_id, $semester_id, Request $request)
    {
        ...
        $schedule = \App\Schedule::where('class_room_id', $class_id)
    ...
    public function storeGradeTeacher(Request $request)
    {
        ...
        return redirect('teacher/grades?kelas=' . $request->class_room_id[$key] . '&semester=' . $request->semester_id[$key])
    ...
    {
        $semesters      = \App\Semester::all();
        $homeroomTeachers = HomeroomTeacher::where('semester_id', $request->semester)
                            ->where('teacher_id', auth()->user()->teacher->id)
                            ->get();
    ...
    public function showStudentHomeroomTeacher($class_id, $semester_id)
    {
        ...
        $classStudents = \App\ClassStudent::where('class_room_id', $class_id)
                            ->where('semester_id', $semester_id)
                            ->get();
